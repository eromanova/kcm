...
func FindProviderInterfaceForInfra(ctx context.Context, rgnClient client.Client, parent parentObject, infra string) *kcmv1.ProviderInterface {
	...
	if err := rgnClient.List(ctx, providerInterfaces,
		client.MatchingLabels{"helm.toolkit.fluxcd.io/name": parent.HelmReleaseName(componentName)},
